...
class SimilarityV5:
    """Reference-engine matcher ported from the supplied fast 100k candle engine.

    Every candidate is normalized by its own min/max range and compared
    point-by-point with RMSE. The score scale and ceiling follow the supplied
    reference engine.
    """

    version = "similarity_v5"
