...
PLANS={
 ...
 "pro":{"name":"Pro","description":"For active traders who want deeper historical research.","price_cents":0,"trial_days":3,"limits":{"searches_per_day":100,"max_matches":20,"timeframes":["1m","5m","15m","1h","4h","1d"]},"features":["100 searches per day","Up to 20 matches per search","All supported timeframes","Binance + global markets","Advanced research modules","3-day Pro trial"]},
 "enterprise":{"name":"Enterprise","description":"For advanced research and future team workflows.","price_cents":0,"trial_days":3,"limits":{"searches_per_day":500,"max_matches":50,"timeframes":["1m","5m","15m","1h","4h","1d"]},"features":["500 searches per day","Up to 50 matches per search","All supported timeframes","Global market coverage","Advanced research and evaluation","3-day Enterprise trial","Team-ready account foundation"]},
}
