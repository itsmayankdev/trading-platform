...
class AdminUser(Base):
    ...
    trial_plan_id: Mapped[int | None] = mapped_column(ForeignKey("admin_plans.id", ondelete="SET NULL"), nullable=True)
    ...
    plan: Mapped[AdminPlan | None] = relationship(foreign_keys=[plan_id])
    trial_plan: Mapped[AdminPlan | None] = relationship(foreign_keys=[trial_plan_id])
