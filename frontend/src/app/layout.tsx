...
export default function RootLayout({children}:LayoutProps<"/">){return <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><body className="min-h-full"><div className="relative min-h-full"><div className="fixed right-4 top-2 z-[60] sm:right-5"><NotificationCenter/></div><AuthGate>{children}</AuthGate></div></body></html>}
