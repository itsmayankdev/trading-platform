...
import { Activity, BarChart3, Play, ShieldCheck } from "lucide-react";
...
type EvaluationResponse = { symbol: string; timeframe: string; pattern_length: number; top_k: number; available_start_time: string; available_end_time: string; evaluation_start_time: string; evaluation_end_time: string; checkpoints: Checkpoint[]; horizons: number[] };
...
function num(value: number | null | undefined) { return value == null ? "—" : value.toFixed(2); }
