...
function HistoricalChartCanvas({ symbol, timeframe, patternLength, match }: { symbol: string; timeframe: string; patternLength: number; match: Match }) {
  ...
  return (
    <div className="relative">
      ...
      <div ref={patternBoxRef} className="pointer-events-none absolute bottom-[28px] top-[8px] z-10 hidden border border-amber-300/70 bg-amber-300/[0.06]" aria-label={`Matched ${patternLength}-candle historical pattern`}>
