...
export default function MarketSelector({ value, onChange, className = "" }: MarketSelectorProps) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      ...
      const params = new URLSearchParams({ search, limit: "12", status: "TRADING", quote_asset: "USDT" });
